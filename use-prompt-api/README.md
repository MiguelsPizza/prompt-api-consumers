...
```typescript
import { useAICapabilities, AICapabilitiesProvider } from '@miguelspizza/use-prompt-api
';
...
```typescript
import { useStatelessPromptAPI } from '@miguelspizza/use-prompt-api
';
...
```typescript
import { useSummarizer } from '@miguelspizza/use-prompt-api
';
